...
class SigNet(nn.Module):
    def __init__(self):
        super().__init__()
        #size = [155, 220, 1]
        self.conv1 = nn.Conv2d(1, 64, 8)  # size = [74,106]
        self.conv2 = nn.Conv2d(64, 128, 7, stride=2,padding=2)  # size = [36, 51]
        self.conv3 = nn.Conv2d(128, 256, 3, stride=2)
        self.conv_bn1 = nn.BatchNorm2d(64)
        self.conv_bn2 = nn.BatchNorm2d(128)
        self.conv_bn3 = nn.BatchNorm2d(256)
        self.fc1 = nn.Linear(17 * 25 * 256, 4098)
        self.fc2 = nn.Linear(4098, 128)
